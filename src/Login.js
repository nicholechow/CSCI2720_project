    ...
    <div>
      {(!this.state.loginflag) ? (
       ...
       <div className='p-4 col-6 m-auto border border-4 border-primary rounded-3'>
         ...
         <div className="p-2 form-group mt-3">
           <label htmlFor="username">Username:</label>
           <input id="username" name="username" type="text" value={this.state.a} onChange={this.handleChange} className="form-control mt-1" placeholder="Enter username here" minlength="4" maxlength="20"/>
         </div>

         <div className="p-2 form-group mt-3">
           <label htmlFor="password">Password:</label>
           <input id="password" name="password" type="password" value={this.state.b} onChange={this.handleChange} className="form-control mt-1" placeholder="Enter password here" minlength="4" maxlength="20"/>
         </div>
